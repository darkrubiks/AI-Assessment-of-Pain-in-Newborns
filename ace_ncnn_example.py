...
def main() -> None:
    ...
    parser.add_argument("--num-concepts", type=int, default=10, help="Number of ACE clusters")
    ...
    ace = ACE(model, target_layer=model.merge_branch[0], device=args.device, batch_size=8)
